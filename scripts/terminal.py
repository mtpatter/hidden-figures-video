...
# From glumpy/examples/gloo-terminal.py which is
...
class TextBuffer(object):
    def __init__(self, rows=24, cols=80, x=0, y=0, scale=2):
        ...
        self._program["scale"] = int(max(3.0, scale))
...
if __name__ == '__main__':
    ...
    console = Console(240, 80, scale=2)
    window = app.Window(width=console.cols*console.scale*7,
                        height=console.rows*console.scale*3,
                        color=(1, 1, 1, 1))  # white console
    ...
    def timer(fps):
        ...
        console.write(" ███████║   ██║   ███████╗██║ ╚═╝ ██║")
        console.write(" ╚══════╝   ╚═╝   ╚══════╝╚═╝     ╚═╝")
        console.write(" →                              Coded for: Hidden Figures")
        console.write(" → Powered by: Science, Technology, Engineering, and Math")
        console.write("───────────────────────────────────────────────────────")
        [console.write("") for _ in range(3)]
    ...
    def blinker():
        """Write blinking new line character"""
        console.write("  >  ")

    def callback(dt):
        blinker()

    clock.schedule_interval(callback, 0.4)
